...
--
-- Host: 127.0.0.1
-- Generation Time: May 25, 2024 at 09:13 AM
...
(28, 'Beasiswa Bersama', 26, 25000000, 150000, '                                Kampus Merdeka Indonesia                           ', 'dedy.jpeg', 'Belum dicairkan'),
(32, 'terbaru', 25, 1300000, 0, 'Testing', 'zakat_yatim2.jpeg', 'Sudah dicairkan'),
(33, 'test', 26, 2340000, 230000, '                            Testing                        ', 'zakat_sesama3.jpeg', 'Sudah dicairkan');
...
INSERT INTO `laporan_pencairan` (`id_laporan`, `id_donasi`, `nama_donasi`, `kategori_donasi`, `dana_cair`, `nama_rekening`, `nomor_rekening`, `nama_penerima`, `detail_pencairan`) VALUES
(4, 33, 'test', 'Sosial', 230000, 'BANK Mandiri', '0812345678', 'Linggar', 'Buat beli cilok'),
(5, 25, 'Patungan Ambulan Gratis untuk Pasien Dhuafa', 'Sosial', 86000000, 'BANK Mandiri', '0812345678', 'Linggar', 'Buat beli cilok');
